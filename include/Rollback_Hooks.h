...
namespace FrameAdvance {
    // Variables
    static u32 framesToAdvance = 1;
    static FrameData currentFrameData;
...
namespace Netplay {
    ...
    static const u8 localPlayerIdxInvalid = 200;
    static u8 localPlayerIdx = localPlayerIdxInvalid;
...
namespace GMMelee {
    // Variables
    static bool isMatchChoicesPopulated = false;
    static int charChoices[MAX_NUM_PLAYERS] = {-1, -1, -1, -1};
